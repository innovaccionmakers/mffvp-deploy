...
{
    public async Task<Result<AlternativeResponse>> Handle(UpdateAlternativeCommand request,
        CancellationToken cancellationToken)
    {
        ...
        return new AlternativeResponse(entity.AlternativeId, entity.AlternativeTypeId, entity.Name, entity.Status,
            entity.Description);
    }
}