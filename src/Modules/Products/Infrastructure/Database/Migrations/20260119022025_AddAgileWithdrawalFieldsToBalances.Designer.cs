...
namespace Products.Infrastructure.Database.Migrations
{
    ...
    [Migration("20260119022025_AddAgileWithdrawalFieldsToBalances")]
    partial class AddAgileWithdrawalFieldsToBalances
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Products.Domain.MinimumWages.MinimumWage", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("MinimumWageId"));
                    ...
                    b.HasKey("MinimumWageId");

                    b.ToTable("salarios_minimos", "productos");
                });
            ...
            modelBuilder.Entity("Products.Domain.PensionFunds.PensionFund", b =>
                {
                    ...
                    b.Property<int>("BusinessCodeSfc")
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Products.Domain.Portfolios.Portfolio", b =>
                {
                    ...
                    b.Property<bool>("AllowsAgileWithdrawal")
                        .HasColumnType("boolean")
