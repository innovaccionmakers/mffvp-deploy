...
public record AffiliateGoalDto(
    ...
    [property: GraphQLName("codigoHomologadoComercial")] string CommercialHomologatedCodeType,
    [property: GraphQLName("codigoHomologadoOficinaApertura")] string OpeningOfficeHomologatedCodeType,
    [property: GraphQLName("codigoHomologadoOficinaActual")] string CurrentOfficeHomologatedCodeType,
