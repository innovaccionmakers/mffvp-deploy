...
//public class YieldDetailCreationServicebck : IYieldDetailCreationService
//{
...
//            ? treasuryConceptSummary.TotalAmount
//            : 0;

//        var expenseAmount = isExpense
//            ? treasuryConceptSummary.TotalAmount
//            : (isIncome && allowsExpense ? -treasuryConceptSummary.TotalAmount : 0);
...
//            TreasuryMovementSummaryExtensions.ToJsonSummary(treasuryConceptSummary),
//            incomeAmount,
//            expenseAmount,
//            0,
//            DateTime.UtcNow,
...
//    public IReadOnlyList<YieldDetail> TreasuryConceptSummaryToYieldDetails(IReadOnlyList<TreasuryMovementSummary> treasurySummary, RunSimulationCommand parameters)
//    {
//        var details = new List<YieldDetail>();
//        foreach (var yieldDetail in treasurySummary)
//        {
//            details.Add(this.TreasuryConceptToYieldDetail(yieldDetail, parameters));
//        }
//        return details;
//    }
//}