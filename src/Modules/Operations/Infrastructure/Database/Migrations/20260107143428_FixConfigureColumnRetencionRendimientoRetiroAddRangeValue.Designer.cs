...
namespace Operations.Infrastructure.Database.Migrations
{
    ...
    [Migration("20260107143428_FixConfigureColumnRetencionRendimientoRetiroAddRangeValue")]
    partial class FixConfigureColumnRetencionRendimientoRetiroAddRangeValue
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Operations.Domain.ClientOperations.ClientOperation", b =>
                {
                    ...
                    b.HasIndex("LinkedClientOperationId");
            ...
            modelBuilder.Entity("Operations.Domain.TrustOperations.TrustOperation", b =>
                {
                    ...
                    b.Property<decimal>("ContributionsPaid")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(19, 2)
                        .HasColumnType("numeric(19,2)")
                        .HasDefaultValue(0m)
                        .HasColumnName("rendimientos_pagados");
                    ...
                    b.Property<decimal>("WithdrawalContributionsTax")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(19, 2)
                        .HasColumnType("numeric(19,2)")
                        .HasDefaultValue(0m)
                        .HasColumnName("retencion_rendimientos_retiro");
            ...
            modelBuilder.Entity("Operations.Domain.ClientOperations.ClientOperation", b =>
                {
                    b.HasOne("Operations.Domain.ClientOperations.ClientOperation", "LinkedClientOperation")
                        .WithMany()
                        .HasForeignKey("LinkedClientOperationId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("LinkedClientOperation");
