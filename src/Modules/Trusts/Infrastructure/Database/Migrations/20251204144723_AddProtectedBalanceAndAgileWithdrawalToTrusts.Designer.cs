...
namespace Trusts.Infrastructure.Database.Migrations
{
    ...
    [Migration("20251204144723_AddProtectedBalanceAndAgileWithdrawalToTrusts")]
    partial class AddProtectedBalanceAndAgileWithdrawalToTrusts
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Trusts.Domain.Trusts.Trust", b =>
                {
                    ...
                    b.Property<decimal>("AgileWithdrawalAvailable")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(19, 2)
                    ...
                    b.Property<decimal>("ProtectedBalance")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(19, 2)
                        .HasColumnType("decimal(19, 2)")
                        .HasDefaultValue(0m)
