    ...
    : ICommandHandler<UpdatePersonCommand, PersonResponse>
{
    public async Task<Result<PersonResponse>> Handle(UpdatePersonCommand request, CancellationToken cancellationToken)
    {
        ...
        if (entity is null) return Result.Failure<PersonResponse>(PersonErrors.NotFound(request.PersonId));
        ...
        return new PersonResponse(entity.PersonId, entity.DocumentType, entity.StandardCode, entity.Identification,
            entity.FirstName, entity.MiddleName, entity.LastName, entity.SecondLastName, entity.IssueDate,
            entity.IssueCityId, entity.BirthDate, entity.BirthCityId, entity.Mobile, entity.FullName,
            entity.MaritalStatusId, entity.GenderId, entity.CountryId, entity.Email, entity.EconomicActivityId);
    }
}