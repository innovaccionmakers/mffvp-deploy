...
{
    public async Task<Result<EconomicActivityResponse>> Handle(CreateEconomicActivityCommand request,
        CancellationToken cancellationToken)
    {
        ...
        if (result.IsFailure) return Result.Failure<EconomicActivityResponse>(result.Error);
