...
{
    public async Task<Result<EconomicActivityResponse>> Handle(UpdateEconomicActivityCommand request, CancellationToken cancellationToken)
    {
        ...
        return new EconomicActivityResponse(entity.EconomicActivityId, entity.Description, entity.CiiuCode, entity.DivisionCode, entity.DivisionName, entity.GroupName, entity.ClassCode, entity.StandardCode);
    }
}