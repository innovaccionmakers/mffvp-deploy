    ...
    IMediator mediator)
{
    ...
    {
        var yieldDetails = await yieldDetailsLocator.GetYieldDetailsByPortfolioIdsAndClosingDateAsync(portfolioIds, processDate, SourceTypes.ExtraYield, cancellationToken);
