...
internal sealed class ClientOperationRepository(ContributionsDbContext context) : IClientOperationRepository
{
    ...
    public async Task<ClientOperation?> GetAsync(Guid clientoperationId, CancellationToken cancellationToken = default)
    {
