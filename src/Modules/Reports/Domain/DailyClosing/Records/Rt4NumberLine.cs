...
public static class Rt4Lines
{
    ...
    public static Rt4NumberLine TransferUnits(decimal value) => new(TransmissionFormatLayout.Rt4.R4313, TransmissionFormatLayout.Rt4.TransferUnits, value, 6, SignMode.AlwaysNegative);
    public static Rt4NumberLine TransferAmount(decimal value) => new(TransmissionFormatLayout.Rt4.R4313, TransmissionFormatLayout.Rt4.TransferAmount, value, 2, SignMode.AlwaysNegative);
    public static Rt4NumberLine PensionUnits(decimal value) => new(TransmissionFormatLayout.Rt4.R4313, TransmissionFormatLayout.Rt4.PensionUnits, value, 6, SignMode.AlwaysNegative);
    public static Rt4NumberLine PensionAmount(decimal value) => new(TransmissionFormatLayout.Rt4.R4313, TransmissionFormatLayout.Rt4.PensionAmount, value, 2, SignMode.AlwaysNegative);
    public static Rt4NumberLine WithdrawalUnits(decimal value) => new(TransmissionFormatLayout.Rt4.R4313, TransmissionFormatLayout.Rt4.WithdrawalUnits, value, 6, SignMode.AlwaysNegative);
    public static Rt4NumberLine WithdrawalAmount(decimal value) => new(TransmissionFormatLayout.Rt4.R4313, TransmissionFormatLayout.Rt4.WithdrawalAmount, value, 2, SignMode.AlwaysNegative);
    public static Rt4NumberLine OtherCommissionUnits(decimal value) => new(TransmissionFormatLayout.Rt4.R4313, TransmissionFormatLayout.Rt4.OtherCommissionUnits, value, 6, SignMode.AlwaysNegative);
    public static Rt4NumberLine OtherCommissionAmount(decimal value) => new(TransmissionFormatLayout.Rt4.R4313, TransmissionFormatLayout.Rt4.OtherCommissionAmount, value, 2, SignMode.AlwaysNegative);
    public static Rt4NumberLine VitalityTransferUnits(decimal value) => new(TransmissionFormatLayout.Rt4.R4313, TransmissionFormatLayout.Rt4.VitalityTransferUnits, value, 6, SignMode.AlwaysNegative);
