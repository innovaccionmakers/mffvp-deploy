...
{
    public async Task<Result<AffiliateResponse>> Handle(UpdateAffiliateCommand request, CancellationToken cancellationToken)
    {
        ...
        return new AffiliateResponse(entity.AffiliateId, entity.IdentificationType, entity.Identification, entity.Pensioner, entity.MeetsRequirements, entity.ActivationDate);
    }
}