...
namespace Activations.Infrastructure
{
    ...
    {
        public static IServiceCollection AddActivationsModule(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddDbContext<ActivationsDbContext>((sp, options) =>
            {
                options.ReplaceService<IHistoryRepository, NonLockingNpgsqlHistoryRepository>()
                       .UseNpgsql(
                            ...
                            npgsqlOptions => npgsqlOptions.MigrationsHistoryTable(HistoryRepository.DefaultTableName, Schemas.Activations)
