namespace Common.SharedKernel.Domain
{
    public static class ContributionErrors
    {
        ...
        public static Error CertifiedRequiredWhenOriginDemands
                                                           => Error.Validation("6281", "El estado del aporte certificado es obligatorio cuando el OrigenAporte ExigeCertificacion es igual a 1");
        public static Error CertifiedValid => Error.Validation("6282", "El campo Aporte Certificado solo recibe valor 'SI' o 'NO'");
        public static Error ExecutionDateMatch => Error.Validation("6283", "La fecha de ejecución debe ser igual a la fecha de operación del portafolio");
        ...
        public static Error PortfolioBelongsToObj => Error.Conflict("6272", "El Portafolio no pertenece a la alternativa del objetivo");
    }
}
