...
public class DatabaseConnectionContext
{
    ...
    public DatabaseConnectionContext(IEnumerable<IDatabaseConnectionStrategy> strategies)
    {
    ...
    {
        var orderedStrategies = _strategies.FirstOrDefault() is YugaByteConnectionStrategy
            ? _strategies
