...
namespace MFFVP.Api.BffWeb.Contributions.TrustOperations
{
    public sealed class TrustOperationsEndpoints
    {
        ...
        public void MapEndpoint(IEndpointRouteBuilder app)
        {
            ...
            .Produces<IReadOnlyCollection<TrustOperationResponse>>(StatusCodes.Status200OK)
            ...
            .Produces<TrustOperationResponse>(StatusCodes.Status200OK)
            .ProducesProblem(StatusCodes.Status500InternalServerError);
