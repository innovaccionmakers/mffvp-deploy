...
{
    public async Task<Result<IReadOnlyCollection<MeetsPensionRequirementResponse>>> GetMeetsPensionRequirementsAsync(
        ISender sender)
    {
    ...
    public async Task<Result> CreateMeetsPensionRequirementAsync(CreateMeetsPensionRequirementCommand request,
        ISender sender)
    {
        return await sender.Send(request);
    }

    public async Task<Result> UpdateMeetsPensionRequirementAsync(UpdateMeetsPensionRequirementCommand request,
        ISender sender)
    {
        return await sender.Send(request);
    }
