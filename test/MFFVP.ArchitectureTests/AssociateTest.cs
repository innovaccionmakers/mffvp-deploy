...
[Collection("AssociateTest")]
public class AssociateTest : BaseTest, IModuleTest
{
    public AssociateTest():base()
    {
        currentModule = nameof(Monolith.Associate);
        
        foreach (var module in AssociateModules)
        {
    ...
    public void DbContextPersistenceLayerClasses_WhenInheritanceIsAttempted_ThenItShouldNotBePossible()
    {
        var result = Types.InCurrentDomain()
            ...
            .And()
            .ImplementInterface(typeof(Associate.Application.Abstractions.Data.IUnitOfWork))
            .Should()
            .BeSealed()
            .GetResult();
